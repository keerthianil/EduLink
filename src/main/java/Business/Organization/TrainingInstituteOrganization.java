...
public class TrainingInstituteOrganization extends Organization {
    private String location;
    private String contactInfo;
    private String missionStatement;
    private WorkshopDirectory workshopDirectory;

    public TrainingInstituteOrganization(String name, String location, String contactInfo, String missionStatement) {
        super(name, Type.Training);
    ...
    // Get the workshop directory for the Training Institute
